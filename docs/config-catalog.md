...
Requires: `webServer` · `subprocess` · `llm` · `agentDefaultModel` · `sessions`
...
Source: [`packages/meeting/live-assist/src/config.ts:11`](../packages/meeting/live-assist/src/config.ts)
...
Requires: `webServer` · `subprocess` · `llm` · `agentDefaultModel`
...
Source: [`packages/meeting/meeting-minutes/src/config.ts:10`](../packages/meeting/meeting-minutes/src/config.ts)
