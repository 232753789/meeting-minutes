...
| [`ndjson-worker`](ndjson-worker/README.md) (`@deepseek-ai/dsh-ndjson-worker`) | — | Consumer helper: one resident NDJSON child process with lazy start, line reading, and idle shutdown |
